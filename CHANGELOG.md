...
## [2.3.0](https://github.com/rokucommunity/release-testing/compare/2.0.0...v2.3.0) - 2025-06-26
### Added
...
### Changed
 - Revert backt older version ([f5632e9](https://github.com/rokucommunity/release-testing/commit/f5632e9))
 - Merge pull request #139 from rokucommunity/release/2.2.1 ([2eb08d3](https://github.com/rokucommunity/release-testing/commit/2eb08d3))
 - Try to convert the string input to a boolean ([1ec9ddb](https://github.com/rokucommunity/release-testing/commit/1ec9ddb))
 - Try to use correct types ([1cdb628](https://github.com/rokucommunity/release-testing/commit/1cdb628))
 - Try to use boolen instead of a string ([722ddfd](https://github.com/rokucommunity/release-testing/commit/722ddfd))
 - Revert "Create a .vsix release" ([9c87a3c](https://github.com/rokucommunity/release-testing/commit/9c87a3c))
 - Merge pull request #136 from rokucommunity/release/2.2.0 ([2f84522](https://github.com/rokucommunity/release-testing/commit/2f84522))
 - found new bug ([17d55ad](https://github.com/rokucommunity/release-testing/commit/17d55ad))
 - Merge pull request #133 from rokucommunity/release/2.1.10 ([496b8a9](https://github.com/rokucommunity/release-testing/commit/496b8a9))
 ...
 - Merge pull request #131 from rokucommunity/release/2.1.9 ([3d34ca5](https://github.com/rokucommunity/release-testing/commit/3d34ca5))
 - Update brighterscript dependency, or downgrade rather ([c7e8eac](https://github.com/rokucommunity/release-testing/commit/c7e8eac))
 ...
 - Merge pull request #127 from rokucommunity/release/2.1.8 ([b9ee0f1](https://github.com/rokucommunity/release-testing/commit/b9ee0f1))
 - Merge pull request #128 from Christian-Holbrook/release/3.0.0 ([8f71334](https://github.com/rokucommunity/release-testing/commit/8f71334))
 ...
 - Merge pull request #126 from rokucommunity/release/2.1.7 ([5508e4d](https://github.com/rokucommunity/release-testing/commit/5508e4d))
 - Update publish-release.yml ([26d22ff](https://github.com/rokucommunity/release-testing/commit/26d22ff))
 - Merge pull request #114 from rokucommunity/release/2.1.6 ([1cef376](https://github.com/rokucommunity/release-testing/commit/1cef376))
 ...
 - Merge pull request #82 from rokucommunity/release/2.1.5 ([e38a05f](https://github.com/rokucommunity/release-testing/commit/e38a05f))
 - Merge pull request #81 from rokucommunity/release/2.1.4 ([e80b5f6](https://github.com/rokucommunity/release-testing/commit/e80b5f6))
 - Merge pull request #74 from rokucommunity/release/2.1.3 ([ff4f6ee](https://github.com/rokucommunity/release-testing/commit/ff4f6ee))
...
## [2.2.1](https://github.com/rokucommunity/release-testing/compare/2.2.0...v2.2.1) - 2025-06-13
### Added
 - Add dispatcher to make-release-artifacts ([40072d4](https://github.com/rokucommunity/release-testing/commit/40072d4))
 - Create a .vsix release ([e59bc1f](https://github.com/rokucommunity/release-testing/commit/e59bc1f))
### Changed
